...
#first the introduction
 ...
 print("okey then, welcome",nombremc)
...
#Now you are in the zombie world 
 ...
 if(e=="a"):
  print("You choose explore the cave, but you don't see nothing weird so you decited to investigate more")
  print("You start to smell something, but it was a bad smell, when you get more closer to the smell you see a person ")
  input()
  print("It was a teenager, he was bleeding, you see that he had a bite on his hand")
 print("Then he saw you and start to scream for help")
 print("You think that the best idea to safe she her is to cut her hand, so the infection dont enter to her all body ")
 input()
########## 
